package com.codingstuff.citysportss.utils.adapter;
...
import com.codingstuff.citysportss.utils.model.ShoeItem;

import java.util.List;

public class
ShoeItemAdapter extends RecyclerView.Adapter<ShoeItemAdapter.ShoeItemViewHolder> {
