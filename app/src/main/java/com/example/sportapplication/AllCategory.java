...
import com.example.sportapplication.adapter.AllCategoryAdapter;
import com.example.sportapplication.adapter.CategoryAdapter;
import com.example.sportapplication.model.AllCategoryModel;
...
public class AllCategory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        allCategoryModelList.add(new AllCategoryModel(1, R.drawable.vetfemme));
        allCategoryModelList.add(new AllCategoryModel(2, R.drawable.chausfemme));
        allCategoryModelList.add(new AllCategoryModel(3, R.drawable.vetementhomme));
        allCategoryModelList.add(new AllCategoryModel(4, R.drawable.chaussurehomme));
        allCategoryModelList.add(new AllCategoryModel(5, R.drawable.vetenfant));
        allCategoryModelList.add(new AllCategoryModel(6, R.drawable.chaussureenfant));
